  ...
  return (
    ...
    <div className='container mx-auto px-4 py-20 mt-10'>
      <div className='flex lg:w-[130vh] w-full gap-3 '>
        ...
        <h2 className='md:text-[48px] lg:text-[48px] text-[36px] font-[700] text-white'>
          Building <span className='bg-blue-950 px-2 py-1 text-white'>Strategies</span> for Your Financial Future
        </h2>
      </div>
