  ...
  return (
   <div>
     <div className='bg-blue-800 bg-cover'>
        <img src="/Internal.webp" alt="" className='w-full  opacity-50 h-96' />
    </div>
    <div className='container mx-auto px-4'>
       ...
       <div className='grid lg:grid-cols-3 md:grid-cols-2 mt-10 gap-10'>
           ...
           <div className='border-2  border-none shadow-xl '>
              <img src="business.jpeg" alt="" className='w-full h-[40vh]' />
              <div className='px-10 py-5 '>
                 <h2 className='font-[600] pt-5 text-[20px]'>Value Added Tax</h2>
                 <p className='py-5'>The bodies were lying in the streets un-buried. All railroads and vessels carrying food and such things into the great city had ceased runnings and mobs of the hungry poor pillaging.</p>
                 <a href="#" className='text-green-700 font-semibold pt-5'>READ MORE</a>
              </div>
           </div>
           <div className='border-2  border-none shadow-xl '>
              <img src="vat.jpeg" alt="" className='w-full h-[40vh]' />
              <div className='px-10 py-5 '>
                 <h2 className='font-[600] pt-5 text-[20px]'> VAT Importance and Staff Awareness</h2>
                 <p className='py-5'>The bodies were lying in the streets un-buried. All railroads and vessels carrying food and such things into the great city had ceased runnings and mobs of the hungry poor pillaging.</p>
                 <a href="#" className='text-green-700 font-semibold pt-5'>READ MORE</a>
              </div>
           </div>
           <div className='border-2  border-none shadow-xl '>
              <img src="vat2.jpeg" alt="" className='w-full h-[40vh]' />
              <div className='px-10 py-5 '>
                 <h2 className='font-[600] pt-5 text-[20px]'>VAT ON Wheels</h2>
                 <p className='py-5'>The bodies were lying in the streets un-buried. All railroads and vessels carrying food and such things into the great city had ceased runnings and mobs of the hungry poor pillaging.</p>
                 <a href="#" className='text-green-700 font-semibold pt-5'>READ MORE</a>
              </div>
           </div>
