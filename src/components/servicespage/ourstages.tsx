...
function Ourstages() {
  return (
    <section className='md:pb-16 pt-12'>
      <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-7 container px-4 mx-auto'>
