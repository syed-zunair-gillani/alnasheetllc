          ...
          <section className="bg-gray-50">
               <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                         <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">The Best Price For You
                         </h2>
                    ...
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 xl:gap-10">
                         <div
                              ...
                              <p className="mt-4 mb-1 text-gray-500 text-light dark:text-gray-400">$19 USD per month, paid annually
                              </p>
                              <a href="#"
                         ...
                         <div
                              className="flex flex-col p-6 mx-auto max-w-xl text-center bg-white rounded-lg border border-[#C5A12B] shadow xl:max-w-lg xl:p-8">
                              <h3 className="mb-4 text-2xl font-medium text-gray-900 ">Starter</h3>
                              <span className="text-5xl font-extrabold text-gray-900 ">$29</span>
                              <p className="mt-4 mb-1 text-gray-500 text-light dark:text-gray-400">$19 USD per month, paid annually
                              </p>
