    ...
    <main className='md:-mt-[60px]'>
      <div className="bg-cover bg-center md:mt-8 py-20 w-full flex flex-col justify-center items-center h-[80vh]" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/main.jpg')` }}>
        <div className='container mx-auto px-4 text-white'>
          <h1 className='font-semibold text-3xl md:text-4xl lg:text-5xl mb-6 '><span className=' bg-[#C6A02E] py-2 px-3  leading-relaxed  '>Accounting</span> & <br />  Bookkeeping</h1>
          ...
          <button className='px-7 py-3 bg-[#C6A02E] hover:bg-blue-800 rounded-full text-white focus:outline-none transition duration-300 text-[16px]'>
            Read More
          </button>
        </div>
      </div>
