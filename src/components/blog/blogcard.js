       ...
       <div className='grid lg:grid-cols-3 md:grid-cols-2 mt-12 gap-10'>
           <div className='border rounded-xl border-gray-200 hover:shadow-xl overflow-hidden'>
              ...
              <div className='px-8 pb-5'>
                 ...
                 <p className='pt-3 pb-3'>Audit Services for Free zone Companies in Dubai, UAE Several free zones based in UAE have different rules and regulations. The same is the case</p>
