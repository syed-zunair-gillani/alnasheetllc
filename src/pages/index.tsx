  ...
  return (
    <main>
      ...
      <section className='flex flex-col sm:flex-row justify-end container mx-auto gap-5 -mt-28 px-2 md:px-0'>
        <div className='bg-[#006F93] text-white p-7 md:p-10 md:py-14 md:flex gap-4 sm:max-w-[400px] rounded-xl shadow-lg'>
        ...
        <div className='bg-[#01B7D6] text-white p-7 md:p-10 md:py-14 md:flex gap-4 sm:max-w-[400px] rounded-xl shadow-lg'>
